  ...
  <MuiThemeProvider>
    <Router history={browserHistory}>
      <Route path="/" component={App}>
        ...
        <Route path="docs" component={Docs} onChange={redirectUnlessSignedIn} onEnter={redirectUnlessSignedIn}/>
        <Route path="forums" component={Forums} onChange={redirectUnlessSignedIn} onEnter={redirectUnlessSignedIn}/>
